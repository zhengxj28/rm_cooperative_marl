cd src
nohup python -u run.py --env_name "pass_room" --map_name "2button2agent" --task_name "pass3" --algorithm "mahrm" --option_elimination --use_wandb --seeds 0 1 2 3 >mahrm.log 2>&1 &
