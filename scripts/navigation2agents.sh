cd src
nohup python -u run.py --env_name "minecraft2" --map_name "nav_map2" --task_name "navigation" --algorithm "mahrm" --option_elimination --use_wandb --seeds 0 1 2 3 >mahrm.log 2>&1 &
