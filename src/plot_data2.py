...
if __name__ == "__main__":
    ...
    title = "Pass Room"
    plt.title(title)
    plot_data_final_version('20220515', env_name, map_name, 'pass3', 'dqprm', 'yellow',label="DQPRM")
    ...
    # env_name = 'minecraft2'
    # map_name = '3A_map_0'
    # title = "MineCraft Task"
    # plt.title(title)
    # plot_data_final_version('20220515', env_name, map_name, 'task3', 'dqprm', 'yellow', label="DQPRM")
    # plot_data_final_version('20220515', env_name, map_name, 'task3', 'iqrm', 'blue', label="IQRM")
    # plot_data_final_version('20220515', env_name, map_name, 'task3', 'modular', 'green', label="MODULAR")
    # plot_data_final_version('20220515', env_name, map_name, 'task3', 'hie_iqrm2', 'red', label="MAHRM(ours)")
