...
def rendezvous_config(num_times, num_agents=3):
    """
    ...
    joint_rm_file = os.path.join(base_file_path, 'reward_machines', 'gridworld_many_agent_rendezvous', '{}_agent_rendezvous_rm.txt'.format(num_agents))

    local_rm_files = []
    for i in range(num_agents):
        local_rm_string = os.path.join(base_file_path, 'reward_machines', 'gridworld_many_agent_rendezvous', 'coordination_experiment_agent{}.txt'.format(i + 1))
